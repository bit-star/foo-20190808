package com.lazulite.foo.config.timezone;

import com.lazulite.foo.FooApp;
import com.lazulite.foo.config.SecurityBeanOverrideConfiguration;
import com.lazulite.foo.repository.timezone.DateTimeWrapper;
import com.lazulite.foo.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, FooApp.class})
